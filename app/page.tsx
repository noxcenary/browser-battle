  ...
  return (
    <main className="bg-cream selection:bg-gold selection:text-navy-deep overflow-x-hidden relative">
      ...
      <div className="relative">
        <div className="sticky top-0 h-screen overflow-hidden z-0"><Hero onExploreClick={() => setIsAdmissionsOpen(true)} /></div>
        ...
        <div className="sticky top-0 min-h-screen overflow-y-auto z-[40] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] bg-cream"><Placements /></div>
